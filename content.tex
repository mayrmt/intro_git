...
\item Always one branch ready to deploy: \code{master} or \code{main}
...
\column{0.7\textwidth}
\begin{itemize}
\item The \code{master} or \code{main} branch is always clean, stable, and deployable.
...
\item When done, bring changes to the \code{master} or \code{main} branch
\end{itemize}
